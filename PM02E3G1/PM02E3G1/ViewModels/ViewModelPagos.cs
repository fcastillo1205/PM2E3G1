...
{
    public class ViewModelPagos : BaseViewModel
    {
        ...
        public async Task newPago()
        {
            ...
            await Application.Current.MainPage.Navigation.PushAsync(new Views.Examen.NewPago());
        }
        #endregion
        ...
        {
            LoadData();
            CommandGuardarPago = new Command(() => InsertMethod());
            CommandTomarFoto = new Command(() => takeFoto());
            CommandGoToNewPago =  new Command(() => newPago());
